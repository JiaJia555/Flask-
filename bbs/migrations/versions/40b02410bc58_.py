...
Revision ID: 40b02410bc58
Revises: edb31f4ee2d4
Create Date: 2020-05-20 20:24:07.059412
...
revision = '40b02410bc58'
down_revision = 'edb31f4ee2d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('signatrue', sa.String(length=100), nullable=True),
